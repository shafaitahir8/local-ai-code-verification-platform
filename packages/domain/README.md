...
- Versioned local approval receipt and policy-approval status records, distinct from executable
...
- Approval statuses distinguish missing, invalid, migration-required, unapproved, approved,
  outdated, and revoked state; a receipt records local authorization evidence but never executes a
  command.
